...
async function initFirebase() {
  try {
    // ═══ MODO DEMONSTRAÇÃO — usa o Firebase de mentira em vez do real ═══
    const mockMod = await import('./demo-firebase-mock.js');
    const { initializeApp } = mockMod;
    const firestoreMod = mockMod;
    ...
    console.warn('[DEMO] Erro ao iniciar o Firebase de mentira:', e);
    firebaseReady = false;
  }
}
